            ...
            <div className="about-container">
                ...
                <div className='about-wrapper'>
                    ...
                    <div className={`about-text ${shouldAnimate ? 'reveal-up' : ''}`} >
                        <p>I am a self-taught front-end web developer from Tbilisi,Georgia. I've always been drawn to the concept of creating something valuable from scratch. Bringing digital ideas to life is my forte. I am hardworking and adaptable, with 2 years of experience in this industry and several completed projects.<br></br> <br></br>These are the Front-End technologies that I've worked with: <br></br><br></br>HTML, CSS , Javascript, React, Tailwind </p>
                        <Link
                            to="projects"
                            smooth={true}
                            duration={1000}
